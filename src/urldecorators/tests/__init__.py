...
class ResolveTestCase(TestCase):
    ...
    def test_resolver_with_decorators(self):
        ...
        self.assertEqual((r.args, r.kwargs), 
                         (("3", "4", "decorator 1 applied", 
                          "decorator 2 applied"), {"arg1":"1", "arg2":"2"}))
    ...
    def test_include_in_resolver_with_decorators(self):
        ...
        self.assertEqual((r.args, r.kwargs), 
                         (("5", "6", "decorator 1 applied", "decorator 2 applied"), 
                          {"arg1":"1", "arg2":"2", "inc_arg1":"3", "inc_arg2":"4"}))
        r = self.client.get("/decorators/1/2/inc/3/4/kwargs/5/6/")
        self.assertEqual((r.args, r.kwargs), 
                         (("decorator 1 applied", "decorator 2 applied"), 
                          {"arg1":"1", "arg2":"2", "inc_arg1":"3", "inc_arg2":"4", 
                           "inc_inc_arg1":"5", "inc_inc_arg2":"6"}))
    ...
    def test_resolver_with_middleware(self):
        ...
        self.assertEqual((r.args, r.kwargs), 
                         (("3", "4", "middleware 1 applied", "middleware 2 applied"), 
                          {"arg1":"1", "arg2":"2"}))
    ...
    def test_include_in_resover_with_middleware(self):
        ...
        self.assertEqual((r.args, r.kwargs), 
                        (("5", "6", "middleware 1 applied", "middleware 2 applied"), 
                         {"arg1":"1", "arg2":"2", "inc_arg1":"3", "inc_arg2":"4"}))
    ...
    if DjangoClassView:
        def test_resolver_with_django_class_view(self):
            r = self.client.get("/decorators/1/2/django-class/")
            self.assertEqual((r.args, r.kwargs), 
                             (("decorator 1 applied", "decorator 2 applied"), 
                              {"arg1":"1", "arg2":"2"}))
            r = self.client.get("/middleware/1/2/django-class/")
            self.assertEqual((r.args, r.kwargs), 
                             (("middleware 1 applied", "middleware 2 applied"), 
                              {"arg1":"1", "arg2":"2"}))
