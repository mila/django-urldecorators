...
def url(regex, view, kwargs=None, name=None, prefix='', decorators=None, middleware_classes=None):
    """
...
def _url(regex, view, kwargs=None, name=None, prefix='', decorators=None,
    ...
    """
    Modified django.conf.urls.defaults.url which use custom RegexURLPattern and RegexURLResolver classes
    """
